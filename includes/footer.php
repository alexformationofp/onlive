            ...
            <div class="row contenuFooter textColor14">
                ...
                <div class="col-md-2">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Tous les lives</a></li>
                        <li><a href="#">Onlive Replay</a></li>
                        <li><a href="#">Impression 3D</a></li>
                ...
                <div class="col-md-4">
                    ...
                    <p class="contenuFooter">
                        ...
                        de type séminaire faites via internet généralement dans un but
                        de travail collaboratif ou d'enseignement à distance.
                    </p>
                </div>
            </div>
        </div>
        <div class="container-fluid py-4">
            <p class="text-center textColor17 basFooter">On Live par <a href="https://www.onlineformapro.com/" target="_blank">ONLINEFORMAPRO</a> - Tous droits réservés 2019 -2020</p>
        </div>
    </footer>
